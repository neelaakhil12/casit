...
export const defaultHubProducts = [
  {
    ...
    defaultSizes: [
      { code: 'A4',    label: 'A4',    dimensions: '8.3 x 11.7 in',  basePrice: 129, framePrice: 250 },
      { code: 'A5',    label: 'A5',    dimensions: '5.8 x 8.3 in',   basePrice: 99,  framePrice: 199 },
      { code: 'A3',    label: 'A3',    dimensions: '11.7 x 16.5 in', basePrice: 199, framePrice: 350 },
      { code: '13x19"',label: '13x19"',dimensions: '13.0 x 19.0 in', basePrice: 299, framePrice: 450 }
    ]
  },
  {
    id: 'split-3',
    ...
    defaultSizes: [
      { code: 'A4',     label: '3x A4 Panels',    dimensions: '3 Panels (25 x 11.7 in)',   basePrice: 387, framePrice: 450 },
      { code: 'A5',     label: '3x A5 Panels',    dimensions: '3 Panels (17.4 x 8.3 in)',  basePrice: 297, framePrice: 390 },
      { code: 'A3',     label: '3x A3 Panels',    dimensions: '3 Panels (35.1 x 16.5 in)', basePrice: 597, framePrice: 650 },
      { code: '13x19"', label: '3x 13x19" Jumbo', dimensions: '3 Panels (39 x 19 in)',     basePrice: 897, framePrice: 850 }
    ]
  },
  {
    id: 'split-2x2',
    ...
    defaultSizes: [
      { code: 'A4', label: '4x A4 Grid (2x2)', dimensions: '4 Panels (16.6 x 23.4 in)', basePrice: 499, framePrice: 550 },
      { code: 'A5', label: '4x A5 Grid (2x2)', dimensions: '4 Panels (11.6 x 16.6 in)', basePrice: 399, framePrice: 450 },
      { code: 'A3', label: '4x A3 Grid (2x2)', dimensions: '4 Panels (23.4 x 33.0 in)', basePrice: 799, framePrice: 750 }
    ]
  },
  {
    id: 'retro',
    ...
    frameStyles: [],
    defaultSizes: [
      { code: 'Standard', label: 'Standard Polaroid', dimensions: '3.5 x 4.2 in', basePrice: 199, framePrice: 0 },
      { code: 'Mini',     label: 'Mini Retro Card',   dimensions: '2.5 x 3.5 in', basePrice: 149, framePrice: 0 }
    ]
  },
  {
    id: 'pocket',
    ...
    frameStyles: [],
    defaultSizes: [
      { code: 'PhoneCase',  label: 'Phone Case Size', dimensions: '2.1 x 3.4 in', basePrice: 99, framePrice: 0 },
      { code: 'WalletCard', label: 'Wallet Card Size', dimensions: '2.5 x 2.5 in', basePrice: 89, framePrice: 0 }
    ]
  },
  {
    id: 'photobooth',
    ...
    frameStyles: [],
    defaultSizes: [
      { code: '3Photo', label: '3-Photo Vertical Strip', dimensions: '2.0 x 6.0 in', basePrice: 149, framePrice: 0 },
      { code: '4Photo', label: '4-Photo Vertical Strip', dimensions: '2.0 x 8.0 in', basePrice: 179, framePrice: 0 }
    ]
  }
];
